                                ...
                                <div class="card">
                                    <div class="card-body card-block">
                                        <div class="card-title">
                                            <h2 class="text-center pt-2 display-5">Add Product</h2>
                                        </div>
                                    </div>
                                </div>
                                
                                <form id="product_form" action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="card">
                                        <div class="card-body card-block">
                                            <div class="card-title">
                                            ...
                                            <div class="row form-group">
                                                <div class="col-3 text-center">
                                                        <div class="kv-avatar">
                                                            <div class="file-loading">
                                                                <input class="img" name="img[]" type="file" required>
                                                        </div>
                                                        </div>
                                                ...
                                                <div class="col-3 text-center">
                                                        <div class="kv-avatar">
                                                            <div class="file-loading">
                                                                <input class="img" name="img[]" type="file">
                                                        </div>
                                                        </div>
                                                        <div class="kv-avatar-hint">
                                                        </div>
                                        ...
                                        <div class="card-body card-block">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="nama_produk" name="nama_produk" placeholder="" class="form-control" required="">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea name="deskripsi" id="deskripsi" rows="5" placeholder="Add your description here.." class="form-control" required=""></textarea>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-8">
                                                    <input type="text" id="harga" name="harga" placeholder="" class="form-control uang" required="">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
